...
- Umiestnenia (Jano 25. 9.): skopírované zo zostavy „AI reklama“ starej kampane (najlepšia, 394,52 €, 7 rezervácií): len Facebook (feed, instream_video, story, facebook_reels, profile_feed, notification) a Instagram (stream, story, reels, explore_home, profile_feed), mobil aj desktop. Bez Audience Network, Messengera a Threads.
- Pred spustením overené: kampaň, zostava aj 35 reklám PAUSED, reklamy prešli kontrolou Mety (žiadna v kontrole ani zamietnutá), žiadne chyby doručovania.
